...
- CSS. The site’s css validation was tested by [jigsaw.w3.org](to clone the repository using HTTPS). The errors identified and fixes are documented [here](assets/images/jigsaw-testing.png).
